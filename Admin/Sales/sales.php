...
?>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
		<?php			echo ' <a class="nav-link" href="/thesis/admin/sales/sortbyyesterday.php?branch=' . $branch . '">Yesday</a>';
							echo ' <a class="nav-link" href="/thesis/admin/sales/sortbytody.php?branch=' . $branch . '">Today</a>';
	...
	$result=$dbconn->query("SELECT * FROM dailysales");
	$sql = "SELECT c.ricebrandname, b.branchname, b.deliveries, b.sold, b.ending, b.total, b.dateofsale FROM dailysales b,riceinfo c WHERE c.id = b.riceid AND b.branchname = '$branch' ORDER BY dateofsale DESC";
