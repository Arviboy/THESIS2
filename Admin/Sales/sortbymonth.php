...
$sql = "SELECT c.ricebrandname, b.branchname, b.deliveries, b.sold, b.ending, b.total, b.dateofsale, b.opricetotal FROM dailysales b,riceinfo c WHERE c.id = b.riceid AND b.branchname = '$branch' AND MONTH(b.dateofsale) = MONTH(CURDATE())";
