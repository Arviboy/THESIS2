...
header('location:adminLogin.html');
  ...
  $result = mysqli_query($dbconn, "SELECT * FROM warehousetransfer")	or die(mysql_error());
?>
   ...
   <nav class="col-md-2 d-none d-md-block bg-light sidebar">
     <div class="sidebar-sticky">
       <ul class="nav flex-column">
         ...
         <li class="nav-item">
           <a class="nav-link  active" href="/thesis/admin/orders.php">
   ...
   <!-- Page Content Holder -->
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2">Warehouse Transfer</h1>
        ...
        <div class="btn-group mr-2">
          ...
          <button class="btn btn-sm btn-outline-secondary">Fill</button>
        </div>

        <?php

        $sql = "SELECT c.ricebrandname, b.transfer, b.branchname, b.dateoftransfer FROM warehousetransfer b,riceinfo c WHERE c.id = b.riceid";
