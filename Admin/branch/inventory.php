...
$nameofbranch = $_GET['nameofbranch'];
?>
		...
		?>
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
					<h1 class="h2">Inventory - <i><?php echo $nameofbranch?></i></h1>
...
<input type='hidden' name='nameofbranch' value='<?php echo "$nameofbranch";?>'/>
<button type="submit" name="submit" class="btn btn-danger" id="reset">End Day</button>
	...
	$sql = "SELECT c.ricebrandname, b.updatedbeginning, b.deliveries, b.retail, b.wholesale, b.sold, b.ending, b.total FROM $nameofbranch b,riceinfo c WHERE c.id = b.sackid";
	$sqltotal = "SELECT total FROM $nameofbranch ";
...
<!-- MODALS ------------------------------------------------------------------------------------>
	...
	<!--For placing wholesale and retail --------------------------------------------->
  	<div class="container">
